    ...
    <section style={{ padding: "160px 32px 80px", textAlign: "center", position: "relative", overflow: "hidden" }}>
      ...
      <Reveal delay={0.16}>
        <p style={{ fontSize: "clamp(16px, 1.8vw, 19px)", color: T.text2, maxWidth: 600, margin: "0 auto 40px", lineHeight: 1.65 }}>
          RevPhlo is a sales intelligence platform for high-ticket teams. AI post-call notes, revenue attribution, live leaderboards, and payment matching — connected to your CRM and payment processor in 48 hours.
        </p>
      </Reveal>
      <Reveal delay={0.24}>
...
function Integrations() {
  const items = [
    ...
    { name: "HubSpot", logo: "data:image/png;base64," },
...
function FAQ() {
  ...
  const items = [
    { q: "What is RevPhlo?", a: "RevPhlo is a sales intelligence platform built for high-ticket sales teams. It provides AI-powered post-call notes, revenue attribution from ad click to cash collected, live sales leaderboards ranked by real revenue, and automated payment matching — replacing manual EOD reports, spreadsheet dashboards, and fragmented reporting with a single real-time dashboard." },
    { q: "What CRMs and tools does RevPhlo integrate with?", a: "RevPhlo integrates with GoHighLevel, HubSpot, Stripe, ThriveCart, Whop, Fathom, Zoom, and Slack. It connects to your existing CRM and payment processor in 48 hours with no migration required." },
    { q: "Who is RevPhlo built for?", a: "High-ticket setter-closer sales teams with 3 or more closers, selling offers at $3,000+, and doing $100K+ per month in revenue. Typical customers include coaching companies, info product businesses, high-ticket service providers, and agency-model businesses." },
    { q: "How long does setup take?", a: "Most teams are fully live within 48 hours. Connect your integrations, map your sources and calendars, and your dashboard starts populating immediately. No data migration required." },
    { q: "How do the AI post-call notes work?", a: "RevPhlo pulls from your call recordings via Fathom or Zoom and uses AI to auto-generate post-call summaries — outcome, objections raised, prospect sentiment, commitments, and follow-up actions. Closers just review and confirm. No manual EOD reports needed." },
    { q: "Does RevPhlo replace GoHighLevel or HubSpot?", a: "No. RevPhlo is not a CRM. It works alongside your existing CRM — whether GoHighLevel, HubSpot, or another supported platform. You keep your CRM for lead management, pipeline tracking, and appointment booking. RevPhlo adds the post-booking intelligence layer: what happened on the call, who collected the most cash, which ad source produced real revenue, and which closers need coaching." },
    { q: "How is RevPhlo different from spreadsheets?", a: "Spreadsheets require manual data entry, are always stale, and depend on human accuracy. RevPhlo pulls data automatically from your CRM, payment processors, and call recorders with zero manual entry. Real-time data, always accurate, no reconciliation needed." },
    { q: "How is RevPhlo different from Databox or other dashboard tools?", a: "Databox is a general-purpose dashboard builder you configure yourself. RevPhlo is pre-configured for high-ticket sales teams — the dashboards are already built with the specific views and metrics that matter for setter-closer operations. No setup, no configuration, no maintenance." },
    { q: "What payment processors does RevPhlo support?", a: "RevPhlo integrates with Stripe, ThriveCart, and Whop. It automatically matches payments from any supported processor to the closer who earned the revenue, the call it came from, and the traffic source that generated the lead." },
    ...
    { q: "What is revenue attribution in RevPhlo?", a: "RevPhlo traces every dollar of cash collected back through the full path: the original ad source, the funnel, the setter who booked the appointment, the closer who ran the call, and the payment that confirmed the deal — regardless of which payment processor was used." },
    { q: "How much does RevPhlo cost?", a: "Pricing is based on team size. Apply for a demo to see the platform with your own data and get a custom quote." },
  ];
  return (
...
export default function RevPhloLanding() {
  ...
  return (
    <div style={{ fontFamily: "'DM Sans', -apple-system, sans-serif", backgroundColor: T.bg, backgroundImage: `url("${dotBg}")`, backgroundRepeat: "repeat", backgroundSize: "24px 24px", color: T.text, lineHeight: 1.6, overflowX: "hidden", WebkitFontSmoothing: "antialiased" }}>
      ...
      <Nav />
      {/* ── SCHEMA.ORG STRUCTURED DATA (invisible, for crawlers + LLMs) ── */}
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "operatingSystem": "Web",
        "description": "RevPhlo is a sales intelligence platform built for high-ticket sales teams. It provides AI-powered post-call notes, revenue attribution from ad click to cash collected, live sales leaderboards, and automated payment matching. Integrates with GoHighLevel, HubSpot, Stripe, ThriveCart, Whop, Fathom, and Zoom.",
        "url": "https://revphlo.com",
        "offers": { "@type": "Offer", "category": "SaaS", "availability": "https://schema.org/OnlineOnly" },
        "featureList": [
          "AI post-call notes", "Revenue attribution from ad click to cash collected",
          "Live sales leaderboards ranked by cash collected", "Automated payment matching",
          "Real-time sales dashboard", "Closer performance analytics",
          "GoHighLevel integration", "HubSpot integration", "Stripe integration",
          "ThriveCart integration", "Whop integration", "Fathom integration", "Zoom integration"
        ],
        "creator": { "@type": "Organization", "name": "RevPhlo", "url": "https://revphlo.com", "foundingDate": "2025" }
      }) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        "@context": "https://schema.org",
        "@type": "FAQPage",
        "mainEntity": [
          { "@type": "Question", "name": "What is RevPhlo?", "acceptedAnswer": { "@type": "Answer", "text": "RevPhlo is a sales intelligence platform built for high-ticket sales teams. It provides AI post-call notes, revenue attribution, live leaderboards, and automated payment matching in a single dashboard. It integrates with CRMs like GoHighLevel and HubSpot and payment processors like Stripe, ThriveCart, and Whop." } },
          { "@type": "Question", "name": "What does RevPhlo integrate with?", "acceptedAnswer": { "@type": "Answer", "text": "RevPhlo integrates with GoHighLevel, HubSpot, Stripe, ThriveCart, Whop, Fathom, Zoom, and Slack. It connects to your existing CRM and payment processor in 48 hours with no migration required." } },
          { "@type": "Question", "name": "Who is RevPhlo for?", "acceptedAnswer": { "@type": "Answer", "text": "RevPhlo is built for high-ticket setter-closer sales teams with 3 or more closers, selling offers priced at $3,000 or more, and doing $100,000 or more per month in revenue." } },
          { "@type": "Question", "name": "Does RevPhlo replace GoHighLevel or HubSpot?", "acceptedAnswer": { "@type": "Answer", "text": "No. RevPhlo works alongside your CRM. You keep GoHighLevel or HubSpot for lead management, pipeline tracking, and appointment booking. RevPhlo adds the post-booking intelligence layer: what happened on the call, who collected the most cash, which ad source produced real revenue, and which closers need coaching." } }
        ]
      }) }} />
      <Hero />
      <BeforeAfter />
      ...
      <footer style={{ padding: "48px 32px 36px", textAlign: "center", borderTop: `1px solid ${T.border}` }}>
        ...
        <div style={{ display: "flex", justifyContent: "center", gap: 20, marginBottom: 24 }}>
          <a href="https://www.linkedin.com/company/revphlo" target="_blank" rel="noopener noreferrer" aria-label="RevPhlo on LinkedIn" style={{ color: T.text3, transition: "color 0.2s" }} onMouseOver={e => e.currentTarget.style.color = T.text} onMouseOut={e => e.currentTarget.style.color = T.text3}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
          </a>
          <a href="https://twitter.com/revphlo" target="_blank" rel="noopener noreferrer" aria-label="RevPhlo on X" style={{ color: T.text3, transition: "color 0.2s" }} onMouseOver={e => e.currentTarget.style.color = T.text} onMouseOut={e => e.currentTarget.style.color = T.text3}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
          </a>
          <a href="https://instagram.com/revphlo" target="_blank" rel="noopener noreferrer" aria-label="RevPhlo on Instagram" style={{ color: T.text3, transition: "color 0.2s" }} onMouseOver={e => e.currentTarget.style.color = T.text} onMouseOut={e => e.currentTarget.style.color = T.text3}>
