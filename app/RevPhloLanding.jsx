...
export default function RevPhloLanding() {
  ...
  useEffect(() => {
    const orgSchema = {
      ...
      "logo": "https://revphlo.com/logo.png",
      "description": "RevPhlo is a sales intelligence platform for high-ticket setter-closer teams. Full visibility into what happens after the call is booked — who's closing, what's converting, and where revenue is leaking.",
      "sameAs": [
        "https://x.com/revphlo",
    ...
    const faqSchema = {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "What CRM / tech stack does RevPhlo work with?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "RevPhlo integrates with GoHighLevel, Zoom, Stripe, Fathom, Zapier, Slack, and Whop via one-click OAuth. If your leads flow through GHL and calls are recorded on Fathom, you're good to go."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Most teams are fully live within 48 hours. Connect your integrations, map your sources and calendars, and your dashboard starts populating immediately."
          }
        },
        {
          "@type": "Question",
          "name": "How do the AI post-call notes work?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "RevPhlo pulls from your Fathom call recordings and uses AI to auto-generate post-call notes — outcome, objection type, prospect details, follow-up actions. Reps just review and confirm. No manual EODs needed."
          }
        },
        {
          "@type": "Question",
          "name": "What kind of teams is RevPhlo built for?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "High-ticket coaching businesses, agencies, SaaS companies, and enterprise sales orgs running sales teams at scale. Whether you're an SMB with 5 reps or an enterprise with 50, if you need post-booking visibility, RevPhlo is built for you."
          }
        },
        {
          "@type": "Question",
          "name": "Can my sales reps see their own data?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes — every rep gets their own portal with personal KPIs, a daily task queue, call recordings, and shareable leaderboard wins."
          }
        },
        {
          "@type": "Question",
          "name": "How does payment matching work?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Stripe payments sync automatically. When the paying email doesn't match the appointment email, search by name or date, match it to the right call, and all attribution data syncs instantly."
          }
        }
      ]
    };
    ...
    return () => {
      try { document.head.removeChild(orgScript); } catch(e) {}
